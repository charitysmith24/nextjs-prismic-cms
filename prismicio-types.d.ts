 ...
 * Primary content in *Hero → Primary*
 */
export interface HeroSliceHorizontialPrimary {
  /**
   * Heading field in *Hero → Primary*
   *
   * - **Field Type**: Title
...
/**
 * Horizontial variation for Hero Slice
 *
 * - **API ID**: `horizontial`
 * - **Description**: Default
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type HeroSliceHorizontial = prismic.SharedSliceVariation<
  "horizontial",
  Simplify<HeroSliceHorizontialPrimary>,
  never
>;
 ...
 */
type HeroSliceVariation = HeroSliceDefault | HeroSliceHorizontial;
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      HeroSliceHorizontialPrimary,
      HeroSliceVariation,
      HeroSliceDefault,
      HeroSliceHorizontial,
      TestimonialsSlice,
