...
const components: JSXMapSerializer = {
  ...
  heading3: ({children}) => (
    <Heading
      as="h3"
      size="sm"
      className="mb-3 font-gi530 font-medium sm:text-left text-center"
    >
      {children}
    </Heading>
  ),
  paragraph: ({ children }) => (
    <p className="text-base font-medium font-gi400 text-slate-600 sm:text-left text-center">{children}</p>
  ),
}
